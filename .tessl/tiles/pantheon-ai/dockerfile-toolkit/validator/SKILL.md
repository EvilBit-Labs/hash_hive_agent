...
For the full list of CKV_DOCKER\_\* security checks, see `references/security_checklist.md`.
...
| `security_checklist.md`    | Container security best practices; full CKV_DOCKER\_\* check listings |
