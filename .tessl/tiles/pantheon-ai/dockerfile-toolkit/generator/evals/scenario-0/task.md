...
=============== FILE: go.mod =============== module github.com/acme/inventory-service

go 1.22

require ( github.com/go-chi/chi/v5 v5.0.12 github.com/jmoiron/sqlx v1.3.5 ) =============== FILE: cmd/server/main.go =============== package main

import ( "fmt" "net/http" )

func main() { http.HandleFunc("/healthz", func(w http.ResponseWriter, r \*http.Request) { fmt.Fprintln(w, "ok") }) http.HandleFunc("/items", func(w http.ResponseWriter, r \*http.Request) { fmt.Fprintln(w, `[]`) }) http.ListenAndServe(":8080", nil) }
